...
urlpatterns = [
    ...
    # path('invoices/<uuid:pk>/status ', views.InvoiceStatusView.as_view(), name='invoice-status'),
    ...
    # PayPal
    path('paypal/create-order/', views.paypal_create_order_async, name='paypal-create-order'),
